...
data = pd.read_csv("/content/drive/My Drive/Colab Notebooks/gender.csv",encoding="latin1")
data = pd.concat([data.sentid,data.sentence],axis=1)
data=data[:30000]
